                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="get" action="/admin/category/category" id="search-form" role="form">
                                ...
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="/admin/category/add"><i
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           href="/admin/category/edit/${item.id}" title="编辑"
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "/admin/category/deleteBatch",
                                data: {
                                    "ids": checkboxValues
                                },
                                async: false,
