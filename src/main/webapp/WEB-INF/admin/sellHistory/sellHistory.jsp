          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-toolbar clearfix">
                <form class="pull-right search-bar" method="get" action="/admin/prosorder/sellHistory" id="search-form" role="form">
                  ...
                  <table class="table table-bordered">
                    ...
                    <c:forEach var="item" items="${list}">
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-xs btn-default" href="/admin/prosorder/sellHistoryDetails/${item.id}" title="查看" data-toggle="tooltip"><i class="mdi mdi-eye"></i></a>
                          </div>
                        </td>
                      </tr>
                    </c:forEach>
