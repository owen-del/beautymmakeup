            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 卖家待签收订单 </span>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="get" action="/admin/prosorder/waitSign" id="search-form" role="form">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="item" items="${list}">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default" href="/admin/prosorder/waitSignDetails/${item.id}" title="查看" data-toggle="tooltip"><i class="mdi mdi-eye"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
