            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 友情链接 </span>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="get" action="/admin/friendshipLink/friendshipLink" id="search-form" role="form">
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <button class="btn btn-default dropdown-toggle" id="search-btn"
                                                    data-toggle="dropdown" type="button" aria-haspopup="true"
                                                    aria-expanded="false">
                                                链接名称 <span class="caret"></span>
                                            </button>
                                        </div>
                                ...
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="/admin/friendshipLink/add"><i
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           href="/admin/friendshipLink/edit/${item.id}" title="编辑"
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "/admin/friendshipLink/deleteBatch",
                                data: {
                                    "ids": checkboxValues
                                },
                                async: false,
                                        ...
                                        $.alert({
                                            ...
                                            buttons: {
                                                confirm: {
                                                    ...
                                                    btnClass: 'btn-primary',
                                                    action: function () {
                                                        window.location.href = "/admin/friendshipLink/friendshipLink";
                                                    }
                                                }
                                            }
                                        });
        ...
        $.alert({
            ...
            buttons: {
                confirm: {
                    ...
                    btnClass: 'btn-primary',
                    action: function () {
                        window.location.href = "/admin/friendshipLink/delete/" + id;
                    }
                },
                cancel: {
                    text: '取消',
