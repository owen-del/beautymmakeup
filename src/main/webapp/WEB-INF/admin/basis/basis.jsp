      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 网站基础信息 </span>
          </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-toolbar clearfix">
                <form class="pull-right search-bar" method="get" action="/admin/mixInfo/basis" id="search-form" role="form">
                        ...
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-xs btn-default"
                               href="/admin/mixInfo/basis/edit/${item.id}" title="编辑"
