...
<main>
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-12">
                    <div class="breadcrumb__wrapper text-center">
                        <h2 class="breadcrumb__title">${zreSources.title}</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="pt-120 pb-120">
        <div class="container">
            <h3 class="mb-30">${zreSources.title}</h3>
            <p>${zreSources.content}</p>

            <img class="w-100" src="${zreSources.filename}" alt="image">
