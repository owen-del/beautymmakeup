...
<main>
    <section class="banner-4 p-relative furniture-banner-area fix bg-image pb-100" data-background="/assets/imgs/furniture/banner/bg.png" data-bg-color="#F5F1E6">
        <div class="swiper banner-active">
            <div class="swiper-wrapper">
                <c:forEach var="item" items="${mixInfoList}">
                                ...
                                <div class="row g-5 align-self-end">
                                    <div class="col-xxl-6 col-lg-6">
                                        <div class="banner-content-4 furniture__content">
                                            ...
                                            <h2 class="banner-title-4">探索美丽世界 <br> 尽在我们的美妆交易平台！</h2>
                                            <p>发现无尽的化妆品选择，满足您的每一个美丽需求。从时尚潮流到经典款式，我们汇聚了最受欢迎的品牌和产品，为您打造独一无二的妆容。点击访问，开启您的美妆之旅！</p>
                                        </div>
                                    </div>
                                    <div class="col-xxl-6 col-lg-6">
